...
public final class LeftLegPoseFeature implements Feature {
    ...
    public ItemStack getItem(Player player, GUIMetaData meta) {
        ...
        im.setDisplayName(ChatColor.YELLOW + "Edit Left Leg Pose");
    ...
    public void operate(Player player, GUIMetaData meta, ClickType click, @NotNull ItemStack oldItem, @NotNull ItemStack newItem) {
        Bukkit.getScheduler().runTask(Util.getPlugin(), () -> {
            ...
            EditorManager.INSTANCE.setEditor(player, new EulerAngleEditor(meta.getArmorStand(), EulerAngleEditor.PoseType.LEFT_LEG));
        });
    }
